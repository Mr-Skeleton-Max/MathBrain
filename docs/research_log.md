...
- **[BubbleStream](https://github.com/Mr-Skeleton-Max/BubbleStream)**: An inference-layer context management framework for existing LLMs. Dual-stream architecture (thinking + memory), 94% memory precision with 16K effective context. Functional prototype, open-sourced separately.
